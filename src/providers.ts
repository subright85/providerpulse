...
export const PROVIDERS: Provider[] = [
  ...
  { id: 'google-ai',  name: 'Google AI',     category: 'llm',     color: '#4285f4', icon: '✨', statusPageUrl: 'https://status.cloud.google.com',  apiUrl: 'https://status.cloud.google.com/incidents.json' },
  ...
  { id: 'deepseek',   name: 'DeepSeek',      category: 'llm',     color: '#00b4d8', icon: '🐋', statusPageUrl: 'https://status.deepseek.com',       apiUrl: 'https://status.deepseek.com/api/v2/summary.json' },
  // Infrastructure
  ...
  { id: 'mongodb',    name: 'MongoDB Atlas', category: 'data',    color: '#00ed64', icon: '🍃', statusPageUrl: 'https://status.mongodb.com',        apiUrl: 'https://status.mongodb.com/api/v2/summary.json' },
  { id: 'upstash',    name: 'Upstash',       category: 'data',    color: '#00e9a3', icon: '🔴', statusPageUrl: 'https://status.upstash.com',        apiUrl: 'https://status.upstash.com/api/v2/summary.json' },
  // Payments & Communication
  { id: 'twilio',     name: 'Twilio',        category: 'payment', color: '#f22f46', icon: '📡', statusPageUrl: 'https://status.twilio.com',         apiUrl: 'https://status.twilio.com/api/v2/summary.json' },
  { id: 'sendgrid',   name: 'SendGrid',      category: 'payment', color: '#1a82e2', icon: '📧', statusPageUrl: 'https://status.sendgrid.com',       apiUrl: 'https://status.sendgrid.com/api/v2/summary.json' },
  { id: 'plaid',      name: 'Plaid',         category: 'payment', color: '#00c98b', icon: '🏦', statusPageUrl: 'https://status.plaid.com',          apiUrl: 'https://status.plaid.com/api/v2/summary.json' },
];
